...
def _build_instructions(protocol_server: ProtocolMCPServer) -> str:
    ...
    sections: list = [
        ...
        "Tool access follows the active mode. The validator quorum is enforced inside the engine loop, not by a caller-held token (ADR 047). A `blocker` is never overridable.\n",
    ]
